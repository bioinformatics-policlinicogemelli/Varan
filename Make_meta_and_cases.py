...
def create_meta_study(cancer, project_name, description, output_dir):
    """
...
def create_meta_clinical_patient(cancer,project_name, output_dir):
    """
...
def create_meta_clinical_sample(cancer,project_name, output_dir):
    """
...
def create_meta_mutations(cancer, project_name, profile, output_dir):
    """
...
def create_meta_sv(cancer,project_name, output_dir):
    """
...
def create_meta_cna(cancer,project_name, output_dir):
    """
...
def create_meta_cna_hg19(cancer,project_name, output_dir):
    """
...
def create_cases_sequenced(cancer, cases_list_dir):
    """
...
def create_cases_cna(cancer, cases_list_dir):
    """
...
def create_cases_sv(cancer, cases_list_dir):
    """
...
def meta_case_main(cancer,output_folder,log=False):
...
if __name__=="__main__":
    ...
    meta_case_main(cancer,output,log=False)